...
puts "Seeding kim"
user4 = User.new(first_name: 'Kimberley', 
  last_name: 'Wong', 
  email: 'kim@gmail.com', 
  password: "123123"
)
...
puts "Christina's responses"

response = Response.new(answer: oop_1_c, question: oop_1_c.question, user: user1)
response.eval_score
response.save!
response = Response.new(answer: oop_2_b, question: oop_2_b.question, user: user1)
response.eval_score
response.save!
response = Response.new(answer: oop_3_d, question: oop_3_d.question, user: user1)
response.eval_score
response.save!

response = Response.new(answer: html_1_c, question: html_1_c.question, user: user1)
response.eval_score
response.save!
response = Response.new(answer: html_2_d, question: html_2_d.question, user: user1)
response.eval_score
response.save!
response = Response.new(answer: html_3_d, question: html_3_d.question, user: user1)
response.eval_score
response.save!


puts "Indy's responses"

response = Response.new(answer: oop_1_b, question: oop_1_b.question, user: user5)
response.eval_score
response.save!
response = Response.new(answer: oop_2_d, question: oop_2_d.question, user: user5)
response.eval_score
response.save!
response = Response.new(answer: oop_3_a, question: oop_3_a.question, user: user5)
response.eval_score
response.save!

response = Response.new(answer: html_1_c, question: html_1_c.question, user: user5)
response.eval_score
response.save!
response = Response.new(answer: html_2_d, question: html_2_d.question, user: user5)
response.eval_score
response.save!
response = Response.new(answer: html_3_a, question: html_3_a.question, user: user5)
response.eval_score
response.save!

puts "Michele's responses"

response = Response.new(answer: oop_1_a, question: oop_1_a.question, user: user2)
response.eval_score
response.save!
response = Response.new(answer: oop_2_c, question: oop_2_c.question, user: user2)
response.eval_score
response.save!
response = Response.new(answer: oop_3_c, question: oop_3_c.question, user: user2)
response.eval_score
response.save!

response = Response.new(answer: html_1_b, question: html_1_b.question, user: user2)
response.eval_score
response.save!
response = Response.new(answer: html_2_d, question: html_2_d.question, user: user2)
response.eval_score
response.save!
response = Response.new(answer: html_3_b, question: html_3_b.question, user: user2)
response.eval_score
response.save!


puts "Millie's responses"

response = Response.new(answer: oop_1_a, question: oop_1_a.question, user: user3)
response.eval_score
response.save!
response = Response.new(answer: oop_2_a, question: oop_2_a.question, user: user3)
response.eval_score
response.save!
response = Response.new(answer: oop_3_d, question: oop_3_d.question, user: user3)
response.eval_score
response.save!

response = Response.new(answer: html_1_d, question: html_1_d.question, user: user3)
response.eval_score
response.save!
response = Response.new(answer: html_2_c, question: html_2_c.question, user: user3)
response.eval_score
response.save!
response = Response.new(answer: html_3_a, question: html_3_a.question, user: user3)
response.eval_score
response.save!

puts "Kim's responses"

response = Response.new(answer: oop_1_a, question: oop_1_a.question, user: user4)
response.eval_score
response.save!
response = Response.new(answer: oop_2_c, question: oop_2_c.question, user: user4)
response.eval_score
response.save!
response = Response.new(answer: oop_3_d, question: oop_3_d.question, user: user4)
response.eval_score
response.save!

response = Response.new(answer: html_1_d, question: html_1_d.question, user: user4)
response.eval_score
response.save!
response = Response.new(answer: html_2_a, question: html_2_a.question, user: user4)
response.eval_score
response.save!
...
puts "Phil's response seeds"

response = Response.new(answer: html_1_a, question: html_1_a.question, user: user7)
response.eval_score
response.save!
response = Response.new(answer: html_2_b, question: html_2_b.question, user: user7)
response.eval_score
response.save!
response = Response.new(answer: html_3_c, question: html_3_c.question, user: user7)
response.eval_score
response.save!

response = Response.new(answer: oop_1_a, question: oop_1_a.question, user: user7)
response.eval_score
response.save!
response = Response.new(answer: oop_2_a, question: oop_2_a.question, user: user7)
response.eval_score
response.save!
response = Response.new(answer: oop_3_d, question: oop_3_d.question, user: user7)
response.eval_score
response.save!
